...
export default function Dashboard() {
  ...
  return <main className="workspace">
    <header className="workspace-header">
      ...
      <div className="workspace-header-right"><span className="workspace-badge"><i /> Private workspace</span><Button className="secondary" onClick={resetAnalysis}><RotateCcw /> New analysis</Button></div>
    </header>
